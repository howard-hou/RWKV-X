...
DATA_FILE="/root/autodl-tmp/RWKV-NonMath-900w"
EXIT_TOKENS="11064460149"
MAGIC_PRIME="2701277"
#######################################################################################################################
#
...
python train.py --load_model $MODEL_FILE --wandb $WANDB --run_name $RUN_NAME --proj_dir $PROJ_DIR \
 ...
 --n_moba_layer $N_MOBA_LAYER --moba_chunk_size $MOBA_CHUNK_SIZE --moba_topk $MOBA_TOPK --accumulate_grad_batches 3